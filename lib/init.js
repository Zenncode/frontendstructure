...
function getReactRouterV7AppRoutesTemplate({ typescript }) {
  if (typescript) {
...
export default AppRoutes;`;
  ...
  if (framework === "react-router-v7") {
    return getReactRouterV7AppRoutesTemplate({ typescript });
  }
...
- \`tests/unit/\` — isolated helper and component tests
- \`tests/e2e/\` — full user-flow checks`;
}
